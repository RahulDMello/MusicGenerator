...
def train_neural_network(x):
    ...
    with tf.Session() as sess:
        ...
        for epoch in range(hm_epochs):
            ...
            epoch_loss = 0
            _, c1 = sess.run([optimizer_1, cost_1], feed_dict = {x:train_data['features'], y:train_data['labels']})
            epoch_loss += c1
            _, c23 = sess.run([optimizer_2_3, cost_2_3], feed_dict = {x:train_data['features'], y:train_data['labels']})
            epoch_loss += c23
